...
public interface BillingApi {
    ...
    String PATH_BILLING_WEBHOOK_POST = "/billing/webhook";
    /**
     * POST /billing/webhook : Payment provider webhook (Admin scope)
     *
     * @return OK (status code 200)
     */
    @Operation(
        operationId = "billingWebhookPost",
    ...
    @RequestMapping(
        ...
        value = BillingApi.PATH_BILLING_WEBHOOK_POST
    )
    default ResponseEntity<Void> billingWebhookPost(
